   ...
   ## your code here
    if me + pending >= goal:
       return 1
        ...
        #Proll = sum([1-Pwin3(you,me+1,0)]+[Pwin3(me, you, pending+i) for i in range(2,7)])/6
        Proll = (1-Pwin3(you,me+1,0)+sum(Pwin3(me, you, pending+i) for i in (2,3,4,5,6)))/6.
        return (Proll if not pending 
                else max(Proll,1 - Pwin3(you, me+pending, 0)) )
